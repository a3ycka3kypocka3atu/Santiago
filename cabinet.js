...
(function () {
  ...
  const ROLE_COPY = {
    ...
    visitor: {
      ...
      text: 'Доступні обране, записи і нагадування для збережених подій.'
    },
    resident: {
      label: 'Club member',
  ...
  const PERSONAL_COPY = {
    visitor: {
      title: 'Мій простір',
      text: 'Базові речі для відвідувача: збережене, записи, нагадування і швидкий перехід до подій та послуг.'
    },
    resident: {
