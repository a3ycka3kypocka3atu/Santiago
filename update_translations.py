...
langs = {'ru': ru, 'en': en, 'cz': cz, 'ua': ua}

with open('/Users/andrij/Desktop/Anti/Сайт/translations.js', 'r') as f:
    content = f.read()

import json
# I will just write a new translations.js file since parsing it perfectly via regex is hard.
# Actually, I'll just use regex to replace specific keys in the JS object, or rewrite the file.
